...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_iso_83(
         ...
         KC_CAPS, MT(MOD_LSFT, KC_A), MT(MOD_LCTL, KC_S), MT(MOD_LALT, KC_D), MT(MOD_LGUI, KC_F), KC_G, KC_H, MT(MOD_RGUI, KC_J), MT(MOD_LALT, KC_K), MT(MOD_RCTL, KC_L), MT(MOD_RSFT, KC_SCLN), KC_QUOT, KC_NUHS, KC_ENT, KC_HOME,
         _______,  KC_NUBS,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,              KC_RSFT,  KC_UP,
         _______,  _______,  _______,                                KC_SPC,                                 _______,  MO(MAC_FN), _______,  KC_LEFT,  KC_DOWN,  KC_RGHT),
